...
const Banner = () => {
    return (
        ...
        <div className="max-w-7xl mx-auto px-5 bg-[#9538E2] rounded-b-2xl ">
            <div className=" max-w-6xl mx-auto bg-[#9538E2] text-center text-white pb-32 rounded-b-2xl relative">

                <h1 className="md:text-6xl text-4xl font-semibold pt-12 pb-6  ">Upgrade Your Tech Accessorize with Gadget Heaven Accessories</h1>
