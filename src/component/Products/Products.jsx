            ...
            <div className="max-w-6xl mx-auto ">
                ...
                <div className="flex gap-5">
                    <div className="bg-white h-[585px] p-6 rounded-2xl border border-gray-200">
                        ...
                        <div className=" bg-gray-100 hover:bg-violet-500 transition duration-[.5s]  hover:text-white font-semibold py-3 pl-5 pr-8 rounded-4xl mb-6">Accessories</div>
                        <div className=" bg-gray-100 hover:bg-violet-500 transition duration-[.5s]  hover:text-white font-semibold py-3 pl-5 pr-8 rounded-4xl mb-6">Smart Watches</div>
                        <div className=" bg-gray-100 hover:bg-violet-500 transition duration-[.5s]  hover:text-white font-semibold py-3 pl-5 pr-8 rounded-4xl mb-6">MacBook</div>
                        <div className=" bg-gray-100 hover:bg-violet-500 transition duration-[.5s]  hover:text-white font-semibold py-3 pl-5 pr-8 rounded-4xl mb-6">Iphone</div>
